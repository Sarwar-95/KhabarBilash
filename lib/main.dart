      ...
      home: DefaultTabController(
        ...
        child: Scaffold(
          ...
          appBar: AppBar(
            ...
            actions: [
              Icon(Icons.favorite , size: 30, color: Color.fromARGB(255, 114, 72, 69),),
           ...
           child: ListView(
             ...
             children: [
              ...
              UserAccountsDrawerHeader(
                accountName: Text('Khabar-Bilash',style: TextStyle(
                  fontSize: 25,
                ),), 
                accountEmail: Text('Food Delivery',
                style: TextStyle(
                  fontSize: 20
                ),),
               ...
               ListTile(
                 ...
                 leading: Icon(Icons.food_bank, size: 30,color: Colors.black,),
               ),
               Divider(color: Colors.red),

               ListTile(
                 title: Text("Food Item", style: TextStyle(
                   fontSize: 25,
                   color: Colors.black
                 ),),
                 
                 leading: Icon(Icons.fastfood, size: 30,color: Colors.black,),
               ),
               Divider(color: Colors.red),
               ...
               ListTile(
                 ...
                 leading: Icon(Icons.supervised_user_circle, size: 40,color: Colors.black,),
               ),
               Divider(color: Colors.red),
               ...
               ListTile(
                 ...
                 leading: Icon(Icons.login_rounded, size: 30,color: Colors.black,),
               ),
               Divider(color: Colors.red),
             ],
           ),
